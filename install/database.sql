...
(1, 'Super Admin', 'admin@site.com', 'admin', NULL, '66823e0b04d5a1719811595.png', '$2y$12$iVxq9YqWAajsDNd7NF6BjeGnxsMcsb4EWF6ddlBpreKIpS.QpHDna', 'QOrYXZg4ry80Yg8ECrFKXDBovjdol2Y8Uq3fSLXRyyP81VJw4fRJCuv0ZHSP', NULL, '2024-06-30 23:26:36');
...
CREATE TABLE `email_histories` (
  ...
  `smtp_id` int NOT NULL DEFAULT '0',
  `batch_id` int NOT NULL DEFAULT '0',
  `status` tinyint UNSIGNED NOT NULL DEFAULT '2' COMMENT '2=scheduled,1=completed,9=failed',
...
(1, 'google-recaptcha2', 'Google Recaptcha 2', 'Key location is shown bellow', 'recaptcha3.png', '\n<script src=\"https://www.google.com/recaptcha/api.js\"></script>\n<div class=\"g-recaptcha\" data-sitekey=\"{{site_key}}\" data-callback=\"verifyCaptcha\"></div>\n<div id=\"g-recaptcha-error\"></div>', '{\"site_key\":{\"title\":\"Site Key\",\"value\":\"---------------\"},\"secret_key\":{\"title\":\"Secret Key\",\"value\":\"-----------------\"}}', 'recaptcha.png', 0, NULL, '2019-10-18 05:16:05', '2024-07-01 00:55:17'),
(2, 'custom-captcha', 'Custom Captcha', 'Just put any random string', 'customcaptcha.png', NULL, '{\"random_key\":{\"title\":\"Random String\",\"value\":\"SecureString\"}}', 'na', 0, NULL, '2019-10-18 05:16:05', '2024-07-01 00:47:12');
...
CREATE TABLE `general_settings` (
  ...
  `smtp_id` int NOT NULL DEFAULT '0',
  `sms_batch_prefix` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_batch_prefix` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
