            ...
            <div class="card b-radius--10">
                <div class="card-body" id="card-body">
                    <ul class="steps-wrapper d-flex justify-content-center mb-3 mt-3 flex-wrap">
                        <li class="step-item">
                            <span class="btn btn--primary custom--primary-btn"
                                  id="collect-mobile-btn">@lang('Collect Mobile Number')</span>
                        </li>
                        <li class="step-item">
                        ...
                        <section id="section-collect-mobile">
                            <form method="POST" id="mobileNumberMerge" action="{{ route('admin.mobile.number.merge') }}">
                                ...
                                <div class="form-group __select2-wrapper" id="group-list">
                                    ...
                                    <select class="form-control select2-multi-select" name="group_id[]" id="group-list"
                                            multiple>
                                ...
                                <div class="form-group">
                                    <label for="" class="fw-bold">@lang('Upload File')</label> <strong
                                            class="uploadInFo"><i class="fas fa-info-circle text--primary"></i></strong>
                                    ...
                                    <div class="mt-2">
                                        <small class="d-block">
                                            @lang('Supported files:') <b class="fw-bold">@lang('csv'), @lang('xlsx'),
                                                @lang('txt')</b>
                                        </small>
                                        <small>
                        ...
                        <section id="section-send-message" class="none">
                            <form method="POST" id="sendMessage" action="{{ route('admin.email.send') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="will_be_sent" class="form-control select2" data-minimum-results-for-search="-1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="date" type="text" value="" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-center flex-wrap gap-4">
                        <button type="submit" class="btn btn--primary nextBtn w-100 h-45"
                                form="mobileNumberMerge">@lang('Next')</button>
                    </div>
                </div>
            </div>
        </div>
...
@push('script')
    <script>
        (function($) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (totalMessageSend < mobileNumbers.length) {
                            setTimeout(() => {
                                formData.set('mobile', mobileNumbers[totalMessageSend])
                                sendMessage(formData)
                            }, 1000);
                        }
                        let percent = parseFloat((totalMessageSend / mobileNumbers.length) * 100).toFixed(
                            2);
            ...
            var nowDate = `{{ showDateTime(now(), 'Y-m-d h:i a') }}`;
