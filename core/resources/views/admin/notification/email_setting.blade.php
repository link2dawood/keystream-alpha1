                        ...
                        <div class="row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control"
                                        ...
                                        value="{{ gs('mail_config')->host ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Port') </label>
                                    <input type="text" readonly class="form-control" placeholder="@lang('Available port')"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" readonly data-minimum-results-for-search="-1"
                                        name="enc">
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Normally your email password')"
                                        name="password" readonly value="{{ gs('mail_config')->password ?? '' }}">
                                </div>
                            </div> --}}
    ...
    <script>
        (function($) {
            ...
            @if (@$_GET['sender'])
                ...
                $(`select[name=email_method]`).val(method).change();
                if (method == 'phpmail') {
                    method = 'php';
                } else if (method == 'smtp') {
                    $("select[name=smtp]").val("{{ gs('smtp_id') }}");
                    setSmtpValue()
                }
                emailMethod(method);
            @endif
